		...
		<nav class="navbar navbar-default">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					...
					<ul class="nav navbar-nav navbar-link">
						<li><a href="register.php"><?php if(isset($_SESSION['user']))echo $_SESSION['user'];else echo '註冊'; ?> <span class="sr-only">(current)</span></a></li>
					</ul>
					<ul class="nav navbar-nav navbar-link">
						<li class="active"><a href="login.php"><?php if(isset($_SESSION['user']))echo '登出';else echo '登入'; ?> <span class="sr-only">(current)</span></a></li>
					</ul>
				</div>
			</div>
		</nav>
